...
This page provides information about the **Cyp6aa, Cyp6p and Cyp6ad cytochrome P450 gene cluster**, a locus for which there is prior
...
.. raw:: html
    ...
    var disqus_config = function () {
        this.page.identifier = '/known-locus/cyp6p';
    };
